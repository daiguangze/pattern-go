...
func (lottery *Lottery) Run(context *Context) error {
	...
	if err := lottery.checkStatus(context); err != nil {
		return err
	}
	if err := lottery.getPrizesByNode(context); err != nil {
		return err
	}
	if err := lottery.deductStock(context); err != nil {
		return err
	}
...
func (lottery *Lottery) getPrizesByNode(context *Context) error {
	return lottery.ConcreteBehavior.getPrizesByNode(context)
}
